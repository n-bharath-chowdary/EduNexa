...
public class student_vid_adapter extends RecyclerView.Adapter<student_vid_adapter.student_vid_View_adapter> {
    private List<video_data> list;
    private Context context;
    private OnViewClickListener viewClickListener;

    public student_vid_adapter(List<video_data> list, Context context, OnViewClickListener viewClickListener) {
        this.list = list;
    ...
    @NonNull
    @Override
    public student_vid_View_adapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.video_rec, parent, false);
        return new student_vid_View_adapter(view);
    }

    @Override
    public void onBindViewHolder(@NonNull student_vid_View_adapter holder, int position) {
    ...
    public class student_vid_View_adapter extends RecyclerView.ViewHolder {
        private TextView video_name, from, to;

        public student_vid_View_adapter(@NonNull View itemView) {
            super(itemView);
