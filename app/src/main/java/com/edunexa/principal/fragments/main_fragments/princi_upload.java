...
public class princi_upload extends Fragment {
    View view;
    private TabLayout tabLayout;
    private ViewPager2 viewPager2;
    private Fragment_adapter_Princi adapter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_princi_upload, container, false);

        tabLayout = view.findViewById(R.id.Princi_tab);
        viewPager2 = view.findViewById(R.id.Princi_vp2);
        adapter = new Fragment_adapter_Princi(getActivity());
