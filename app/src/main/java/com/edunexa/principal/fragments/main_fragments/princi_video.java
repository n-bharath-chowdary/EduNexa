...
public class princi_video extends Fragment {
    View view;
...
//        adapter.setOnViewClickListner(this::viewVideo);
    ...
    private void addVideos(String addingFilename) {
        StorageReference videoRef = storef.child("Princi_videos/" + addingFilename + selected);
    ...
    private void uploadData(String s) {
        ...
        video_data videodata = new video_data(adding_filename, downloadurl, selected, ukey, "Principal");
