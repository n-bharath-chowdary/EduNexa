...
public class princi_img extends Fragment {
    ...
    private void addImages(String addingFilename) {
        StorageReference videoRef = storef.child("Princi_images/" + addingFilename + selected);
    ...
    private void uploadData(String s) {
        ...
        img_data imgData = new img_data(adding_filename, downloadurl, selected, ukey, "Principal");
