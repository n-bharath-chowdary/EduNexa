...
public class princi_pdf extends Fragment {
    View view;
...
//        adapter.setOnViewClickListner(this::viewPdf);
    ...
    private void addPDFS(String addingFilename) {
        StorageReference pdfRef = storef.child("Princi_pdfs/" + addingFilename + selected);
        pdfRef.putFile(uri)
    ...
    private void uploadData(String s) {
        ...
        pdf_data filedata = new pdf_data(adding_filename, downloadurl, selected, ukey, "Principal");
