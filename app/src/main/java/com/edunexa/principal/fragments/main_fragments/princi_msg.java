...
public class princi_msg extends Fragment {
    View view;
    ...
    private EditText et;
    private String msg, selected, college;
    ...
    public void deleteMsg(int msgid) {
        Call<String> deletedRows = db.delete_princi_Message(msgid);
    ...
    private void getMessages() {
        Call<List<msg_data>> call = db.get_princi_Message();
    ...
    private void addMSG(String s) {
        ...
        msg.setFrom("Principal");
        msg.setCollege_name(college);

        Call<String> post = db.add_princi_Message(msg);
