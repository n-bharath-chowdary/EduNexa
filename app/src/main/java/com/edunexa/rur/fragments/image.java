...
//        adapter.setOnClickListener(this::viewImage);
    ...
    private void addImages(String addingFilename) {
        StorageReference videoRef = storef.child("RUR_images/" + addingFilename + selected);
    ...
    private void uploadData(String s) {
        ...
        img_data imgData = new img_data(adding_filename, downloadurl, selected, ukey, "RUR");
