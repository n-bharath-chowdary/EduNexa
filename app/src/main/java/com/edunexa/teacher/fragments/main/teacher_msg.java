...
public class teacher_msg extends Fragment {
    View view;
    ...
    private EditText et;
    private String msg, des, college;
    ...
    public void deleteMsg(int msgid) {
        Call<String> deletedRows = db.delete_teacher_Message(msgid);
    ...
    private void getMessages() {
        Call<List<msg_data>> call = db.get_teacher_Message();
    ...
    private void addMSG(String s) {
        ...
        msg.setMsg(s);
        msg.setSend_to("student");
        msg.setFrom("Teacher");
        msg.setDes(des);
        msg.setCollege_name(college);


        Call<String> post = db.add_teacher_Message(msg);
