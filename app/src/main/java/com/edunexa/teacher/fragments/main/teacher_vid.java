...
public class teacher_vid extends Fragment {
    View view;
...
//        recyclerView2.setAdapter(sendto_adapter);
    ...
    private void addVideos(String addingFilename) {
        StorageReference videoRef = storef.child("Teacher_videos/" + addingFilename + "student");
    ...
    private void uploadData(String s) {
        ...
        video_data videodata = new video_data(adding_filename, downloadurl, "student", ukey, "Teacher");
