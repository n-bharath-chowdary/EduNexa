...
public class teacher_pdf_rec extends Fragment {
    ...
    private teacher_pdf_adapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new teacher_pdf_adapter(list, getContext(), new teacher_pdf_adapter.OnViewClickListener() {
            @Override
