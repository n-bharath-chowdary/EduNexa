...
public class teacher_img_adapter extends RecyclerView.Adapter<teacher_img_adapter.teacher_img_View_adapter> {

    private List<img_data> list;
    private Context context;
    private OnViewClickListener viewClickListener;

    public teacher_img_adapter(List<img_data> list, Context context, OnViewClickListener viewClickListener) {
        this.list = list;
    ...
    @NonNull
    @Override
    public teacher_img_View_adapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.image_rec, parent, false);
        return new teacher_img_View_adapter(view);
    }

    @Override
    public void onBindViewHolder(@NonNull teacher_img_View_adapter holder, int position) {
    ...
    public class teacher_img_View_adapter extends RecyclerView.ViewHolder {
        private ImageView imageView;
        private int pos;
        private Button del_btn;
        private TextView from, to;

        public teacher_img_View_adapter(@NonNull View itemView) {
            super(itemView);
